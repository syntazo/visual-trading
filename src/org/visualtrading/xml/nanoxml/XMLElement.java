 ...
 * #getStringAttribute(java.lang.String) getStringAttribute}. The following example shows how to list the attributes of
 * an element: <UL><CODE> XMLElement element = ...;<BR> Enumeration enum = element.getAttributeNames();<BR> while
 * (enum.hasMoreElements()) {<BR> &nbsp;&nbsp;&nbsp;&nbsp;String key = (String) enum.nextElement();<BR>
 * &nbsp;&nbsp;&nbsp;&nbsp;String value = element.getStringAttribute(key);<BR> &nbsp;&nbsp;&nbsp;&nbsp;System.out.println(key
 * + " = " + value);<BR> } </CODE></UL></DD></DL> <DL><DT><B>Retrieving Child Elements</B></DT> <DD> You can enumerate
 * the children of an element using {@link #enumerateChildren() enumerateChildren}. The number of child elements can be
 * retrieved using {@link #countChildren() countChildren}. </DD></DL> <DL><DT><B>Elements Containing Character
 * Data</B></DT> <DD> If an elements contains character data, like in the following example: <UL><CODE> &lt;title&gt;The
 * Title&lt;/title&gt; </CODE></UL> you can retrieve that data using the method {@link #getContent() getContent}.
 * </DD></DL> <DL><DT><B>Subclassing XMLElement</B></DT> <DD> When subclassing XMLElement, you need to override the
 * method {@link #createAnotherElement() createAnotherElement} which has to return a new copy of the receiver.
 * </DD></DL> <P>
 *
...
// ------------------------------ FIELDS ------------------------------
     ...
     * <li>The keys and the values are strings. </ul></dd></dl>
     */
     ...
     * "quot"&nbsp;=&gt;&nbsp;"\"", "apos"&nbsp;=&gt;&nbsp;"'", "amp"&nbsp;=&gt;&nbsp;"&amp;" <li>The keys are strings
     * <li>The values are char arrays </ul></dd></dl>
     */
...
// --------------------------- CONSTRUCTORS ---------------------------
     ...
     * XMLElement(new Hashtable(), false, true) </code></ul>
     * <p/>
     * <dl><dt><b>Postconditions:</b></dt><dd> <ul><li>countChildren() => 0 <li>enumerateChildren() => empty enumeration
    ...
    /**
     * Creates and initializes a new XML element. Calling the construction is equivalent to: <ul><code>new
     * XMLElement(new Hashtable(), skipLeadingWhitespace, true) </code></ul>
     *
     ...
     *                              <li>enumerateChildren() => empty enumeration <li>enumeratePropertyNames() => empty
     ...
     *                 </ul></dd></dl>
     *                 <p/>
     *                 <dl><dt><b>Postconditions:</b></dt><dd> <ul><li>countChildren() => 0 <li>enumerateChildren() =>
    ...
    /**
     * Creates and initializes a new XML element. <P> This constructor should <I>only</I> be called from {@link
     * #createAnotherElement() createAnotherElement} to create child elements.
     *
     * @param entities                 The entity conversion table.
     * @param skipLeadingWhitespace    <code>true</code> if leading and trailing whitespace in PCDATA content has to be
     *                                 removed.
     ...
     *                                 <p/>
     *                                 <dl><dt><b>Postconditions:</b></dt><dd> <ul><li>countChildren() => 0
     *                                 <li>enumerateChildren() => empty enumeration <li>enumeratePropertyNames() =>
     *                                 empty enumeration <li>getChildren() => empty vector <li>getContent() => ""
...
// -------------------------- OTHER METHODS --------------------------
     ...
     * @see nanoxml.XMLElement#getDoubleAttribute(java.lang.String, java.util.Hashtable, java.lang.String, boolean)
     ...
     * @see nanoxml.XMLElement#getIntAttribute(java.lang.String, java.util.Hashtable, java.lang.String, boolean)
     ...
     * @see nanoxml.XMLElement#getAttribute(java.lang.String, java.util.Hashtable, java.lang.String, boolean)
     ...
     * @see nanoxml.XMLElement#getStringAttribute(java.lang.String, java.lang.String) getStringAttribute(String,
     *      String)
     * @see nanoxml.XMLElement#getStringAttribute(java.lang.String, java.util.Hashtable, java.lang.String, boolean)
     ...
     *
     * @deprecated Use {@link #getIntAttribute(java.lang.String, java.util.Hashtable, java.lang.String, boolean)
     ...
     * to defaultKey is returned. <P> As an example, if valueSet contains the mapping <code>"one" => 1</code> and the
     * element contains the attribute <code>attr="one"</code>, then <code>getIntAttribute("attr", mapping, defaultKey,
     * false)</code> returns <code>1</code>.
     *
     * @param name                The name of the attribute.
     ...
     *                            <li>the keys of <code>valueSet</code> are strings <li>the values of
     ...
     * Returns an attribute by looking up a key in a hashtable.
     *
     * @deprecated Use {@link #getAttribute(java.lang.String, java.util.Hashtable, java.lang.String, boolean)
     ...
     * Returns an attribute by looking up a key in a hashtable.
     *
     * @deprecated Use {@link #getDoubleAttribute(java.lang.String, java.util.Hashtable, java.lang.String, boolean)
    ...
    /**
     * Returns an attribute by looking up a key in a hashtable. If the attribute doesn't exist, the value corresponding
     * to defaultKey is returned. <P> As an example, if valueSet contains the mapping <code>"one" =&gt; 1.0</code> and
     * the element contains the attribute <code>attr="one"</code>, then <code>getDoubleAttribute("attr", mapping,
     * defaultKey, false)</code> returns <code>1.0</code>.
     *
     * @param name                The name of the attribute.
     * @param valueSet            Hashtable mapping keys to values.
     * @param defaultKey          Key to use if the attribute is missing.
     ...
     * Returns an attribute by looking up a key in a hashtable.
     *
     * @deprecated Use {@link #getStringAttribute(java.lang.String, java.util.Hashtable, java.lang.String, boolean)
     ...
     * Returns an attribute by looking up a key in a hashtable. If the attribute doesn't exist, the value corresponding
     * to defaultKey is returned. <P> As an example, if valueSet contains the mapping <code>"one" => "1"</code> and the
     * element contains the attribute <code>attr="one"</code>, then <code>getAttribute("attr", mapping, defaultKey,
     * false)</code> returns <code>"1"</code>.
     *
     * @param name          The name of the attribute.
     * @param valueSet      Hashtable mapping keys to values.
     ...
     *                      keys of <code>valueSet</code> are strings <li>the values of <code>valueSet</code> are
     *                      strings </ul></dd></dl><dl>
     *
     * @see nanoxml.XMLElement#setAttribute(java.lang.String, java.lang.Object) setAttribute(String, Object)
     * @see nanoxml.XMLElement#removeAttribute(java.lang.String) removeAttribute(String)
     ...
     *                      </dl><dl><dt><b>Preconditions:</b></dt><dd> <ul><li><code>name != null</code>
     *                      <li><code>name</code> is a valid XML identifier <li><code>valueSet</code> != null <li>the
     *                      keys of <code>valueSet</code> are strings </ul></dd></dl><dl>
     *
     * @see nanoxml.XMLElement#setAttribute(java.lang.String, java.lang.Object) setAttribute(String, Object)
     * @see nanoxml.XMLElement#removeAttribute(java.lang.String) removeAttribute(String)
     * @see nanoxml.XMLElement#enumerateAttributeNames()
     ...
     *              <li>enumerateChildren() => old.enumerateChildren() + child <li>getChildren() =>
     *              old.enumerateChildren() + child </ul></dd></dl><dl>
     *
     * @see nanoxml.XMLElement#countChildren()
     * @see nanoxml.XMLElement#enumerateChildren()
     * @see nanoxml.XMLElement#getChildren()
